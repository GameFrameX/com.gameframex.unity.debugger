...
using UnityEditor;
using UnityEngine;
using GameFrameX.Debugger.Runtime;

namespace GameFrameX.Debugger.Editor
{
    [CustomEditor(typeof(DebuggerComponent))]
    internal sealed class DebuggerComponentInspector : ComponentTypeComponentInspector
    {
        ...
        {
            RefreshComponentTypeNames(typeof(IDebuggerManager));
        }
